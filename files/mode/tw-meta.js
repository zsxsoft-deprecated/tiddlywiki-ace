!(function(e) {
  'object' === typeof exports && 'object' === typeof module ? e(require('../lib/ace')) : 'function' === typeof define && define.amd ? define(['../lib/ace'], e) : e(ACE)
 }
 (function(e) {
  'use strict';
  e.modeInfo = [{
  ...
  e.findModeByMIME = function(t) {
   ...
   for (var m = 0; m < e.modeInfo.length; m++) {
    ...
    if (i.mimes)
     for (var a = 0; a < i.mimes.length; a++)
      if (i.mimes[a] == t) return i
   }
   ...
   for (var m = 0; m < e.modeInfo.length; m++) {
    var i = e.modeInfo[m];
    if (i.ext)
     for (var a = 0; a < i.ext.length; a++)
      if (i.ext[a] == t) return i
   }
   ...
   var a = t.lastIndexOf('.');
   var o = a > -1 && t.substring(a + 1, t.length);
   ...
   for (var m = 0; m < e.modeInfo.length; m++) {
    ...
    if (i.alias)
     for (var a = 0; a < i.alias.length; a++)
      if (i.alias[a].toLowerCase() == t) return i
   }
